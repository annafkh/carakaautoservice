...
"> Caraka </span> Auto</h1>
			...
			<div class="form">
				<form action="proses_logboking.php" method="post">
					<div class="form-group">
						<span class="form-icon"><i class="fa fa-user"></i></span>
						<input type="text" class="form-input" placeholder="username" name="username_pel" autofocus="">
					</div>
					<div class="form-group">
				...
				<a href="daftar.php"><button class="btn btn-warning btn-block">Daftar</button></a>
			</div>
		</div>
	</div>
